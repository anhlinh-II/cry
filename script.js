...
let rainlevel= document.querySelector(".rainlevel");
...
let getWeatherByCityName = async (cityName) => {
    ...
    document.querySelector(".visibility").innerText = data.visibility + " m";
    document.querySelector(".windspeed").innerText = data.wind.speed + " m/s";
    document.querySelector(".humidity").innerText = data.main.humidity + " %";
    document.querySelector(".rainlevel").innerText = data.rain && data.rain["1h"] ? `${data.rain["1h"]} mm` : "No rain";
    document.querySelector(".sunrise").innerText = new Date(data.sys.sunrise * 1000).toLocaleTimeString("en-US", { hour: "numeric", minute: "numeric", hour12: true, });
    document.querySelector(".sunset").innerText = new Date(data.sys.sunset * 1000).toLocaleTimeString("en-US", { hour: "numeric", minute: "numeric", hour12: true, });
    };
    ...
    forecastList.sort((a, b) => a.dt - b.dt);
        ...
        return forecastHour >= currentHour;}) || forecastList[0];
